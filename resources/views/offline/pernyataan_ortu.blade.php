...
window.onafterprint = function (e) {
    window.close();
        ...
        <div style="font-size: 19px; font-family: 'Arial';">
            ...
            <p style="font-size: 19px; font-family: 'Arial';">Yang bertanda tangan di bawah ini, saya :</p><br>
            <table style="font-size: 19px; font-family: 'Arial';">
                <tr>
                    <td>Nama Lengkap </td>
                    <td> : <?= $data->nama ?></td>
                </tr>
            ...
            <div class="float-right" style="font-size: 19px; font-family: 'Times New Roman', Times, serif;">
                Banyuwangi, <?= date('d-m-Y'); ?> <p>Yang Membuat pernyataan,</p> <br><br><br><br><br>

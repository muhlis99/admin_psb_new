            ...
            <div class="card-body">
                <div class="col-md-9">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $mahrom = DB::table("tb_mahrom")
                                ->join('tb_detail_mahrom', 'tb_mahrom.id_mahrom' ,'=', 'tb_detail_mahrom.id_mahrom')
                                ->where("id_person", $data->id_person)->get();
                            $no=1;
                            foreach ($mahrom as $mr) {
                                ?>
                                <tr>
                                    <td><?php echo $no ?></td>
                                    <td><?php echo $mr->hubungan ?></td>
                                    <td><?php echo $mr->nik_m ?></td>
                                    <td><?php echo $mr->nama_mahrom ?></td>
                                    <td><?php echo $mr->tanggal_lahir ?></td>
                                    <td><?php echo $mr->alamat_mahrom?></td>
                                </tr>
                                <?php
                                $no++;
                            }
